...
export type ToolResult = WeatherResult | { content: string } | string | ErrorResult;
  ...
  try {
    switch (name) {
      ...
      case 'generate_image': {
        ...
        // We don't fetch the image, we just return the URL. The AI will decide what to do with it.
        // The frontend will render it if it sees the URL.
        return imageUrl;
      }
      default: {
